...
| 3   | Coding standards & tooling       | Foundation | done        | No             | 2            |
...
**Done when:** `/audit` has run to align `AGENTS.md` and all quality gates pass without warnings. _(Note: `/audit` was captured at project inception; pre-commit checks configured in `/develop tooling`)_.

- [x] Capture conventions and tooling setup: `/audit`
- [x] Configure lint, formatting, and pre-commit checks: `/develop tooling`
